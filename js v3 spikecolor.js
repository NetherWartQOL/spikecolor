var password = prompt("Enter in your password!"); //blyatmangayshit
        if (password=="E56G4Sgvegas6GVEa56AEGE87654ebEBGTJ665487u54k8646589žřčš7") {
...
$("li").css('cursor', 'url(https://cdn.discordapp.com/attachments/965021405823529040/967711898680311858/spectral_set.png), default');
        ...
        {
            alert("Wrong password! Game started without textures!");
        }
